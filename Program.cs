...
formData.Add(new StringContent("xukuan","UTF-8", "text/plain"), "username");
formData.Add(new StringContent("MTIzNDU2", "UTF-8", "text/plain"), "passc");
formData.Add(new StringContent("MTAwMDIxNjM2Mw==", "UTF-8", "text/plain"), "USERID");
